...
The benchmark datasets are available from PMLB \cite{olson2017pmlb}. The open-source implementation, scripts, tables, and an experimental package for spherical tree and $k$-sighted tree experiments will be available in the \href{https://github.com/MathiasValla/non-greedy-decision-trees}{project GitHub repository}.
